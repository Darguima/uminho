...
/* package Pacman-0.1.0.0 */
#ifndef VERSION_Pacman
#define VERSION_Pacman "0.1.0.0"
#endif /* VERSION_Pacman */
#ifndef MIN_VERSION_Pacman
#define MIN_VERSION_Pacman(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Pacman */
...
#define CURRENT_COMPONENT_ID "Pacman-0.1.0.0-inplace-Pacman"
